...
with Strong Security Guarantees.](https://eprint.iacr.org/2017/666) (2017) by Katriel Cohn-Gordon et al. I would also highly recommend their official publicly available [recorded presentation](https://www.youtube.com/watch?v=tCKd6xBqyDw), which I found extremely helpful.
...
### Repository Contents
 ...
 | `presentation_ART.pdf`            | Presentation slides I used to explain ART within the seminar. |
 | `references.bib`            | bib-file containing the references used in the summary paper. |
